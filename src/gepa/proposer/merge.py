...
def find_common_ancestor_pair(
    ...
    for _ in range(max_attempts):
        ...
        # Check that neither candidate is an ancestor of the other
...
def sample_and_attempt_merge_programs_by_common_predictors(
    ...
    for _ in range(max_attempts):
        ...
        for pred_name in pred_names:
            ...
            pred_id2 = program_candidates[id2][pred_name]
            if (pred_anc == pred_id1 or pred_anc == pred_id2) and pred_id1 != pred_id2:
                # Ancestor's predictor matches one descendant and differs from the other;
                # use the descendant that differs from the ancestor
                same_as_ancestor_id = 1 if pred_anc == pred_id1 else 2
                ...
                # Both predictors differ from the ancestor; select the descendant with the higher score
                ...
                # Both predictors are identical; selecting either descendant is fine
